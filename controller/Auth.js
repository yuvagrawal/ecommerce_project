...
//mongodb+srv://yuvagrawal:Yuv_50800@cluster0.kdqh483.mongodb.net/ecommerce?retryWrites=true&w=majority&appName=Cluster0
...
exports.resetPasswordRequest = async (req,res) =>{
    ...
    if(user){
        ...
        await user.save();
        const resetPageLink = "https://ecommercesiteproject-yuvraj-agrawals-projects.vercel.app/reset-password?token="+token+"&email="+email;
