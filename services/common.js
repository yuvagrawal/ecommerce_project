...
const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "yuvrajagrawal61@gmail.com",
...
exports.cookieExtractor = function(req){
    ...
    //token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2NDBhNDgyZTMwNzdkNjc1ZDM3MjY2YiIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzE1NTEyNDUwfQ.-sB-PE7a1KK6pW5qXWInoK-0FvjdRBlPYzClB6qSA_E";
    return token;
}

exports.sendMail = async function({to,subject,text,html}){
        let info = await transporter.sendMail({
          from: '"E-Commerce" <yuvrajagrawal61@gamail.com>', // sender address
          to,
          subject,
          text,
          html
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="yuvrajagrawal61@gmail.com>contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">You received this email because we received a request for placing order at our ecommerce site  from  your account. If you didn't place any order you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end permission -->
